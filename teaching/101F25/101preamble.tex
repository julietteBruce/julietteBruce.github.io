...
\fancypagestyle{firstpageCR}{%
  \fancyhf{}
\fancyhead[L]{\footnotesize Dartmouth College \\ Math 101: Linear \& Multilinear Algebra}
\fancyhead[R]{\footnotesize \href{https://www.juliettebruce.xyz/teaching/101F26}{Fall 2026}}
...
\setlist[problems]{label=\arabic*.,ref=\arabic*,leftmargin=*,itemsep=9pt,topsep=3pt,resume,before=\Needspace{8\baselineskip}}
\setlist[enumerate,1]{label=(\alph*),ref=\alph*,leftmargin=1.9em,itemsep=3pt,topsep=3pt}
\setlist[enumerate,2]{label=(\roman*),leftmargin=1.9em,itemsep=2pt,topsep=2pt}
